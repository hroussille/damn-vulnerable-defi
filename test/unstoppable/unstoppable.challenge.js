...
describe("[Challenge] Unstoppable", function () {
  ...
  it("Exploit", async function () {
    /** The pool checks its initial balance from the token and saves it to storage.
     *  Uppon lending, it checks that the final balance equals that "initial" balance...
     *  The vulnerability is that anyone can send tokens to the pool address and therefore
     *  make that balance check fail. The lending pool is forever disabled.
     */
